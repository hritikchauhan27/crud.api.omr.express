...
const likes_on_comments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let comment_id = 0;
        yield user_model_1.Comments.findAll()
            .then((result) => {
            result.forEach((record) => {
                comment_id = record.id;
                const printlike = (comment_id) => __awaiter(void 0, void 0, void 0, function* () {
                    const likedata = yield user_model_1.Likes.findOne({ where: { comment_id: comment_id } });
                    if (likedata == null) {
                        console.log(`Likes:=${0}`);
                    }
                    else {
...
//# sourceMappingURL=l.p.c.controller.js.map